...
const char* ssid     = "TP-LINK_46D02C";       // 连接WiFi名（此处使用taichi-maker为示例）
                                            // 请将您需要连接的WiFi名填入引号中
const char* password = "32416500";          // 连接WiFi密码（此处使用12345678为示例）                                         // 请将您需要连接的WiFi密码填入引号中
                                            // 请将您需要连接的WiFi密码填入引号中
...
const char* reqUserKey = "SY7PlK2gea4ynluag";   // 私钥
const char* reqLocation = "xuzhou";            // 城市，可使用"ip"自动识别请求 IP 地址
